...
(function () {
		...
		for (var s = 0; s < e.length; ++s) {
			...
			if (!a.helper.isString(i.type))
				return (
					(n.valid = !1),
					(n.error =
						o + 'property "type" must be a string, but ' + typeof i.type + ' given'),
					n
				);
			...
			} else if (a.helper.isUndefined(i.filter) && a.helper.isUndefined(i.regex))
				return (
					(n.valid = !1),
					(n.error =
						o +
			...
			if (i.filter) {
				if ('function' != typeof i.filter)
					return (
						(n.valid = !1),
						(n.error =
							o + '"filter" must be a function, but ' + typeof i.filter + ' given'),
						n
					);
			} else if (i.regex) {
				if (
				...
				if (a.helper.isUndefined(i.replace))
					return (
						(n.valid = !1),
						(n.error =
							o + '"regex" extensions must implement a replace string or function'),
						n
					);
			}
		}
	...
	a.subParser('autoLinks', function (e, r, t) {
		...
		a.subParser('codeSpans', function (e, r, t) {
			'use strict';
			return (
				void 0 === (e = t.converter._dispatch('codeSpans.before', e, r, t)) && (e = ''),
				(e = e.replace(/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm, function (e, n, s, o) {
					var i = o;
					return (
						(i = i.replace(/^([ \t]*)/g, '')),
						(i = i.replace(/[ \t]*$/g, '')),
		...
		a.subParser('hashHTMLBlocks', function (e, r, t) {
			...
			var n = [
				...
				s = function (e, r, a, n) {
					var s = e;
					return (
						-1 !== a.search(/\bmarkdown\b/) && (s = a + t.converter.makeHtml(r) + n),
		...
		a.subParser('paragraphs', function (e, r, t) {
			...
			for (
				...
				l.search(/¨(K|G)(\d+)\1/g) >= 0
					? s.push(l)
					: l.search(/\S/) >= 0 &&
					  ((l = (l = a.subParser('spanGamut')(l, r, t)).replace(/^([ \t]*)/g, '<p>')),
					  (l += '</p>'),
					  s.push(l));
			}
		...
		a.subParser('strikethrough', function (e, r, t) {
			...
			return (
				r.strikethrough &&
					((e = (e = t.converter._dispatch('strikethrough.before', e, r, t)).replace(
						/(?:~){2}([\s\S]+?)(?:~){2}/g,
						function (e, n) {
							return (function (e) {
								return (
		...
		a.subParser('makeMarkdown.list', function (e, r, t) {
			...
			for (
				var s = e.childNodes, o = s.length, i = e.getAttribute('start') || 1, l = 0;
				l < o;
				++l
			)
