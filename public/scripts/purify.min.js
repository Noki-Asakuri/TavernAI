			...
			dt = function (t) {
				(ft && ft === t) ||
					...
					t.CUSTOM_ELEMENT_HANDLING &&
						...
						(De.attributeNameCheck = t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),
					t.CUSTOM_ELEMENT_HANDLING &&
						'boolean' ==
		...
		var Tt = function (e) {
			...
			Et = function (e) {
				...
				return (
					...
					at === ot ? pe.call(t, ze ? 'html' : 'body')[0] : ze ? t.documentElement : a
				);
			},
			wt = function (e) {
				return fe.call(
			...
			kt = function (e) {
				...
				return e instanceof f && !Tt(e)
					...
					? (Fe &&
							...
							(t = _(t, Te, ' ')),
							e.textContent !== t &&
								(A(r.removed, { element: e.cloneNode() }), (e.textContent = t))),
		...
		return (
			(r.sanitize = function (e) {
				...
				if ((He || dt(c), (r.removed = []), 'string' == typeof e && (Ke = !1), Ke)) {
					...
					(1 ===
						(n = (t = Et('\x3c!----\x3e')).ownerDocument.importNode(e, !0)).nodeType &&
						'BODY' === n.nodeName) ||
					'HTML' === n.nodeName
						? (t = n)
						: t.appendChild(n);
